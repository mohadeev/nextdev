export const news = [
  {
    id: "1",
    name: "Next Dev latest App Development",
    slug: "Next-Dev-latest-App-Development",
    date: "June 09, 2021",
    time: "10:00 PM EST",
    detail:
      "2022 players for the Test series against New Zealand in order to give the cricketers a break. New Zealand will play England in a two-match Test series which gets underway from June 2 at Lord's in London. According to a report in BBC, England players who featured in IPL 2021 before the tournament was postponed will not be hurriedly picked for the Test series. Chris Woakes, Sam Curran, Moeen Ali, Jos Buttler, and Jonny Bairstow all played at least a game in the postponed IPL and are now in mandatory 10-day isolation after returning to the UK.",
    image: "/images/news/news1.jpg",
  },
  {
    id: "2",
    name: "The Meta Verse World",
    slug: "The-Meta-Verse-World",
    date: "June 2, 2021",
    time: "8:00 PM EST",
    detail:
  ...
  {
    id: "3",
    name: "England Pacer Harry Gurney Retires",
  ...
  {
    id: "4",
    name: "CSK Seek To Regain Their Dominance",
  ...
  {
    id: "5",
    name: "Turkish Grand Prix Cancelled, Replaced By 2nd Race In Austria",
  ...
  {
    id: "6",
    name: "Mercedes Masterstroke In Barcelona Helps Lewis Hamilton Deny Max Verstappen",
  ...
  {
    id: "7",
    name: "Rafael Nadal Takes Revenge On Alexander Zverev",
  ...
  {
    id: "8",
    name: "Novak Djokovic Sweeps Into Italian Open Quarter-Finals",
  ...
  {
    id: "9",
    name: "Hideki Matsuyama Holds Off Xander Schauffele To Win Historic Masters Title",
  ...
  {
    id: "10",
    name: "Singapore Open 2021 Cancelled Due To Surge In COVID-19 Cases",
...
export default async function Sulg(req, res) {
  if (req.method === "GET") {
